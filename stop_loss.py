...
# Use create_app para obter o app e socketio configurados
...
@app.route('/')
def index():
    return render_template('indexloss.html')
...
def verificar_preco_alvo(ticker_symbol, preco_alvo, destinatario, operacao, identificador):
    ...
    try:
        ...
        while True:
            ...
            time.sleep(INTERVALO_VERIFICACAO)  # Aguarda 300 segundos entre as verificações
